...
def test_predefined_scenarios():
    ...
    test_scenarios = [
        ...
        {
            'event': 'Your project deadline was moved earlier',
    ...
    for i, scenario in enumerate(test_scenarios, 1):
        ...
        results = detector.analyze_event(
            scenario['event'],
            scenario['relevance'],
            scenario['congruence'],
            scenario['control'],
        ...
        print(f"   Predicted: {results['emotion'].upper()} (Confidence: {results['confidence']:.2f})")
        print(f"   Dimensions: R={results['relevance']:.1f}, C={results['congruence']:+.1f}, "
              f"Co={results['control']:.1f}, N={results['novelty']:.1f}")
